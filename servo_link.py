...
class UdpServoLink:
    ...
    def __init__(self, host: str, port: int = 8770):
        ...
        # Always allow broadcast targets: the autostart path resolves the ESP32 by
        # the subnet broadcast address (zero-config, survives DHCP changes on the
        # ESP). Harmless for unicast destinations.
        try:
